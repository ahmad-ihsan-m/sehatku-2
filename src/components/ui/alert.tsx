  ...
  "relative w-full rounded-2xl border px-4 py-3 text-sm [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground [&>svg~*]:pl-7",
  {
    variants: {
      variant: {
        ...
        warning:
          "border-amber-500/50 bg-amber-50/50 text-amber-700 dark:text-amber-400 [&>svg]:text-amber-600",
        success:
          "border-emerald-500/50 bg-emerald-50/50 text-emerald-700 dark:text-emerald-400 [&>svg]:text-emerald-600",
      },
    },
    defaultVariants: {
      variant: "default",
